...
class RobertaEncoder(FairseqDecoder):
    ...
    def forward(self, src_tokens, features_only=False, return_all_hiddens=False, masked_tokens=None, inputs_embed=None, **unused):
        """
        Args:
        ...
        """
        x, extra = self.extract_features(src_tokens, return_all_hiddens=return_all_hiddens, inputs_embed=inputs_embed)
        if not features_only:
            x = self.output_layer(x, masked_tokens=masked_tokens)
        return x, extra

    def extract_features(self, src_tokens, return_all_hiddens=False, inputs_embed=None, **unused):
