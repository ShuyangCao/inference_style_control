...
class SentencePredictionTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--freeze-roberta', action='store_true')
    ...
    def build_model(self, args):
        ...
        if getattr(self.args, 'freeze_roberta', False):
            for p in model.decoder.sentence_encoder.embed_tokens.parameters():
