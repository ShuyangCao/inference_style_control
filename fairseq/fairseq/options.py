...
def add_optimization_args(parser):
    ...
    parser.add_argument('--reinit-epoch', action='store_true')
    # fmt: on
    return group
...
def add_generation_args(parser):
    ...
    group.add_argument('--print-attn', action='store_true',
                       help='if set, uses attention feedback to compute and print alignment to source tokens')
    group.add_argument('--print-step', action='store_true')
    group.add_argument('--ori-task', action='store_true')
    group.add_argument('--alignment-layer', type=int)
